...
public class FotoPublic2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(FotoPublic2.this, "Error" + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        if (filePath != null) {
            ...
            ref.putFile(filePath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            Toast.makeText(FotoPublic2.this, " обновление ", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(FotoPublic2.this, "fail uploaded", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    private void chekCameraPermission() {
        if (ContextCompat.checkSelfPermission(FotoPublic2.this, Manifest.permission.CAMERA)
                != PackageManager.PERMISSION_GRANTED
                || ContextCompat.checkSelfPermission(FotoPublic2.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(FotoPublic2.this, new String[]{
...
//            openCamera();
    ...
    public void onBackPressed() {
        try {
            Intent intent = new Intent(FotoPublic2.this, profileId.class); // try = попытка
