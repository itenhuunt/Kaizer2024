...
public class AdapterGeneralChat extends RecyclerView.Adapter<AdapterGeneralChat.MyHolder> {

    Context context;
    List<ModelGeneralChat> commentList;
    String inkognitoid, postId;

    public AdapterGeneralChat(Context context, List<ModelGeneralChat> commentList, String inkognitoid, String postId) {
        this.context = context;
        this.commentList = commentList;
        this.inkognitoid = inkognitoid;
        this.postId = postId;
    }
    ...
    public void onBindViewHolder(@NonNull MyHolder myHolder, int i) {
        ...
        //set user dp
        try {
            Picasso.get().load(image).placeholder(R.drawable.diamond).into(myHolder.avatarIv);
        } catch (Exception e) {
        ...
        myHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //chek if this comment is by currently signed in user or not
                if (inkognitoid.equals(uid)) {
                    //my comment
                    //show delete dialog
                    AlertDialog.Builder bulder = new AlertDialog.Builder(v.getRootView().getContext());
                    bulder.setTitle("Delete");
                    bulder.setMessage("Are you sure to delete this comment?");
                    bulder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                        @Override
