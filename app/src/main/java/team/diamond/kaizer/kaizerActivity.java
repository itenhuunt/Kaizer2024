...
public class kaizerActivity extends AppCompatActivity {
    ...
    ImageView help, profileImg, writeGeneralChatImg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animationView2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(kaizerActivity.this, StreamAllHere.class);
                    startActivity(intent);
                    finish();
                } catch (Exception e) {
                    //empty
        ...
        writeGeneralChatImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(kaizerActivity.this, writeGeneralChat.class);
                    startActivity(intent);
                    finish();
                } catch (Exception e) {
                    //empty
    ...
    private void hooks() {
        ...
        writeGeneralChatImg = findViewById(R.id.writeGeneralChat);
